...
import static com.example.sakshi.imdb.R.id.poster;
import static com.example.sakshi.imdb.R.id.watch;
import static com.example.sakshi.imdb.R.id.watchlist;

/**
 * Created by sakshi on 9/1/2017.
 */
...
public class MainActivity2 extends AppCompatActivity implements DataListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        watchimage = (ImageView) findViewById(watch);
    ...
    private void checkMovie(String Id) {
       ...
       // db.deleteNonFavWatchMovie();
        ...
        if (!check) { //checks if movie does not existing in database
           ...
           // DetailsModel movieInfo = db.getMovie(Id);
            if (fav.equals("0")) { //set image based on database value
                favimage.setImageResource(R.drawable.favorite_disable_normal);
                favimage.setTag("disable");
                model.setIsFav("0");
            ...
            if (watch.equals("0")) { //set image based on database value
                watchimage.setImageResource(R.drawable.watchlist_disable_normal);
                watchimage.setTag("disable");
                model.setIsWatchlist("0");
            } else {
